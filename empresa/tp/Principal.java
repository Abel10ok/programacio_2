...
public class Principal {
	...
	public static void main(String[] args) throws Exception {
			 ...
			 // - GasistaInstalacion
			 // - GasistaRevision
			 EmpresaDeServicios empresa = new EmpresaDeServicios("El Tano Constructor");
			 ...
			 int cli2_gasista=empresa.solicitarServicioGasistaInstalacion(37223451, 20, "bulevar333", 3, 3200);
