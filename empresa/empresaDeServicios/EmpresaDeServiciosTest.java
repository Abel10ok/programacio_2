...
public class EmpresaDeServiciosTest {
	...
	public void setUp() throws Exception {
		...
		empresa = new EmpresaDeServicios("empresa");
		...
		empresa.finalizarServicio(cli1_elec1, 30000); // facturacion = 30000 + 700*20 44.000
		empresa.finalizarServicio(cli2_elec2, 10000); // facturacion = 10000 + 650*2 11.300
		empresa.finalizarServicio(cli1_elec2, 5000); // facturacion = 5000 + 650*10 11.500
	...
	@Test
	public void registrarEspecialistaNuevo_finalizaOK() throws Exception {
	...
	@Test(expected = RuntimeException.class)
	public void registrarEspecialistaRepetido_generaError() throws Exception {
		empresa.registrarEspecialista(nroEspecialistaElectrisista, "clienteX", "1146453465", SERVICIO_GASISTA_REVISION);
	}

	@Test(expected = RuntimeException.class)
	public void registrarEspecialistaDeTipoDesconocido_generaError() throws Exception {
		empresa.registrarEspecialista(nroEspecialistaNuevo1, "EspecialistaServicioDesconocido", "1146453465",
				"Carpintero");
	}

	@Test
	public void solicitarServicios_finalizaOK() throws Exception {
	...
	@Test(expected = RuntimeException.class)
	public void solicitarServicioConNroEspecialidadInvalido_generaError() throws Exception {
		empresa.solicitarServicioPintura(dniClienteRegistrado, nroEspecialistaNuevo1, "otra Calle 871", 9, 2000);
	}

	@Test(expected = RuntimeException.class)
	public void solicitarServicioConDniClienteInvalido_generaError() throws Exception {
		empresa.solicitarServicioPintura(dniClienteNuevo, nroEspecialistaPintor, "otra Calle 871", 9, 2000);
	}

	@Test(expected = RuntimeException.class)
	public void solicitarServicioConTipoEspecialidadInvalido_generaError() throws Exception {
